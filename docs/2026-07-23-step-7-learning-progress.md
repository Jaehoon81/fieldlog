...
현재 수정 대기 항목은 없다. 1-4에서 발견한 상태 문구 누락, 2단원 시작 전 전체 source 대조에서 발견한 학습 주석 오류와 3단원 시작 전 상세 화면 header option 누락을 아래와 같이 반영했다. 2·3단원 시작 전 보완은 해당 단원의 학습 시작이나 완료로 계산하지 않는다.
