...
// [FLOW-04 / 관련 코드] 작성 미리보기가 이 공용 component를 재사용합니다.
// [FLOW-05 / 관련 코드] 저장된 기록 상세도 같은 component를 재사용합니다.
// 작성 미리보기와 저장된 기록 상세가 이 컴포넌트를 재사용합니다.
...
export function SnapshotSummary({
  ...
  // [FLOW-06 / 관련 코드] 사용자가 고른 온도 설정에 맞춰 숫자 옆 단위 문자를 정합니다.
