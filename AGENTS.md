...
- 대화형 학습 단계에서는 `docs/learning-guide.md`와 `docs/2026-07-23-step-7-learning-progress.md`를 함께 사용하고, source 안의 학습 주석 표식과 `FLOW` 읽기 순서는 `docs/source-commentary-guide.md`를 따릅니다.
...
- Git, GitHub, EAS, account, credential과 실기기 작업은 해당 작업에 대한 사용자의 명시적 승인 후에만 수행합니다.
...
- `src/`는 type, schema, API, database, app-wide query 정책, application state, hook과 공용 component를 담당합니다.
